...
public class AgentHelper {
    ...
    private final static Logger logger = Logger.getMyLogger(AgentHelper.class.getName());
    /**
     ...
     */
    public static ServiceDescription addSD(String type) {
        ServiceDescription sd = new ServiceDescription();
        sd.setType(type);
        return sd;
    }
     ...
     */
    public static DFAgentDescription addDFD(ServiceDescription service) {
        DFAgentDescription dfd = new DFAgentDescription();
